...
class FSController(KesslerController):
    def __init__(self):
        ...
        rules_is_threat = [
            ...
            ctrl.Rule(collision_time['L'] & closest_dist['H'], is_threat['L']),
            ctrl.Rule(collision_time['H'] & closest_dist['H'], is_threat['L']),
            ctrl.Rule(collision_time['H'] & closest_dist['L'], is_threat['H']),
            ctrl.Rule(collision_time['M'] | closest_dist['M'], is_threat['H'])
        ]
        ...
        rules_target = [
            ctrl.Rule(closest_dist['L'], thrust_target['M']),
